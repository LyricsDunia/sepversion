      ...
      <section id="categories" className="py-16 bg-gray-50" data-name="categories" data-file="components/Categories.js">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[var(--text-primary)] mb-4">Browse by Category</h2>
            <p className="text-lg text-[var(--text-secondary)] max-w-2xl mx-auto">
              Explore our curated selection of electronic gadgets
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map(category => (
              ...
              >
                ...
                <h3 className="text-xl font-semibold text-[var(--text-primary)] mb-2">{category.name}</h3>
                <p className="text-[var(--text-secondary)] mb-3">{category.description}</p>
                
                <div className="flex justify-between items-center">
                  <span className="text-sm font-medium text-[var(--primary-color)]">{category.count} products</span>
